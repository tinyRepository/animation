        ...
        <div class="hidden-container">
            ...
            <div class="coin">
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="77" xmlns:xlink="http://www.w3.org/1999/xlink" class="coin-tail">
                    <use fill="url(#b1)" fill-opacity=".5" xlink:href="#a1" transform="translate(.71 13.276)"/>
                    <use fill="url(#d1)" fill-opacity=".5" xlink:href="#c1" transform="translate(8.86)"/>
                    <defs>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="coin-body">
                    <g transform="translate(-1280 -149)">
                        <use xlink:href="#a" transform="translate(1281 150.828)" class="border-circle"/>
                        <mask id="b">
                    ...
                    <g transform="translate(-1280 -149)">
                        <use xlink:href="#d" transform="translate(1287 157)" class="inner-circle"/>
                        <mask id="e">
...
<style lang="scss" scoped>
    ...
    .bet-container {
        ...
        .coin {
            ...
            flex-direction: column;
            margin-bottom: 20px;
            animation: slideDown $mainTime 1 forwards, levitation $levitationTime $mainTime*4 $sumLevitaionItteration forwards;
